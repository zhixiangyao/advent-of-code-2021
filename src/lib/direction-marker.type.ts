...
export type DirectionMarker = DirectionArrowSymbol | DirectionCardinalGeographicLetter | DirectionCardinalLiteralLetter

export const isDirectionArrowSymbol = (marker: string): marker is DirectionCardinalGeographicLetter =>
...
export const isDirectionCardinalLiteralLetter = (marker: string): marker is DirectionCardinalLiteralLetter =>
